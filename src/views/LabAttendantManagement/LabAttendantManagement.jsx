...
class LabAttendantManagement extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
onSubmit(e){
  ...
  console.log('Lab attendant ', requestBody)
  this.setState({isLoadingCreateNurse: true});
      this.props.createLabAttendant(requestBody)
      .then(res => {
        ...
        if(res.payload.status === 201){
          ...
          this.showAlert('Success', `Lat attendant has been created successfully.\n Staff Id is ${this.state.staffId}.
      ...
      <div className="content">
          ...
          <Row>
            {
              <Col md={12}>
                <CardWithButton
                  ...
                  category="All the lab attendants on the platform"
                  ctTableFullWidth
                  ctTableResponsive
                  showButton={true}
                  onButtonClick={() => this.open()}
                  buttonName="Add New Lab Attendant"
                  content={
                    !this.state.nurses ? (
                      <Loading isLoading={this.state.isLoadingNurses} />
                    ) : (
        ...
        <Modal show={this.state.showModal} onHide={this.close.bind(this)}>
          <ModalHeader closeButton>
            <ModalTitle>
              <strong>Setup Lab attendant</strong>
            </ModalTitle>
          </ModalHeader>
          <ModalBody>
