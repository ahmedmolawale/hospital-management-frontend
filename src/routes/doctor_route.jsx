...
import AssignedPatientManagement from 'views/doctor/AssignedPatientManagement/AssignedPatientManagement';
...
const appRoutes = [
    ...
    { path: "/doctor/patient-assigned", name: "Assigned Patients", icon: "pe-7s-user", component: AssignedPatientManagement },
    ...
    { redirect: true, path:"/doctor", to:"/doctor/patient-assigned", name: "Assigned Patients" }
];
