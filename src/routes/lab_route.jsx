...
import AssignedPatientManagement from 'views/lab/AssignedPatientManagement/AssignedPatientManagement';
...
const appRoutes = [
    ...
    { path: "/lab/patient-assigned", name: "Assigned Patients", icon: "pe-7s-user", component: AssignedPatientManagement },
    ...
    { redirect: true, path:"/lab", to:"/lab/patient-assigned", name: "Assigned Patients" }
];
